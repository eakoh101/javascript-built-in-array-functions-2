...
const newBills = bills.filter(function(showBill){return showBill.member !== null})
...
// Hint🕵️
// Function สำหรับกรองข้อมูลใน Array ของ JavaScript คือ filter() สามารถทบทวนวิธีการใช้งานได้ ที่นี่
// .filter() จะรับ Callback Function ที่ return เป็น true หรือ false เพื่อเลือกว่าจะเก็บ Element ไหนไว้ใน Array ใหม่
// ในแต่ละ Element (แต่ละบิล) เราสามารถตรวจสอบว่า member มีค่าเป็น null หรือไม่ ด้วยการเช็กเงื่อนไขแบบนี้: bill.member !== null